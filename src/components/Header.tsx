              ...
              <SheetContent side="left" className="w-[300px] sm:w-[400px]">
                ...
                <ScrollArea className="h-[70vh] mt-4">
                  <nav className="flex flex-col space-y-4 px-[20px] py-[0px] pr-4">
                    ...
                    <a href="#database-processing" onClick={() => window.location.hash = 'database-processing'} className="text-sm hover:text-primary transition-colors pl-2">5. Database Processing</a>
                    <a href="#surgery-readiness-assessment-results" onClick={() => window.location.hash = 'surgery-readiness-assessment-results'} className="text-sm hover:text-primary transition-colors pl-2">6. Surgery Readiness Assessment Results</a>
                    <a href="#surgery-readiness-assessment-feedback" onClick={() => window.location.hash = 'surgery-readiness-assessment-feedback'} className="text-sm hover:text-primary transition-colors pl-2">7. Surgery Readiness Assessment Feedback</a>
                    <a href="#surgery-conditioning-protocol-challenge" onClick={() => window.location.hash = 'surgery-conditioning-protocol-challenge'} className="text-sm hover:text-primary transition-colors pl-2">8. Surgery Conditioning Protocol Challenge</a>
