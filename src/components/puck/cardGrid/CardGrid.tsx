...
const popularIcons = [
  ...
  "Folder", "HeartBreak", "Key", "Layers", "Link", "Mic",
  "Paperclip", "PieChart", "Power", "Repeat", "RotateCcw",
  "SearchPlus", "SearchMinus", "Sliders", "Sun", "Moon",
  "Tag", "Terminal", "Tool", "Truck", "Umbrella", "Watch", 
  "WifiOff", "ZapOff", "ZoomIn", "ZoomOut", "Activity", "Airplay",
  "AlertOctagon", "Aperture", "Archive", "ArrowDownCircle",
  "ArrowUpCircle", "AtSign", "BarChart", "Battery",
  "Bell", "Bluetooth", "Book", "Box", "Briefcase", "Bug",
  "Bus", "Calculator", "Cast", "CheckCircle", "ChevronDown",
  "ChevronUp", "ChevronsLeft", "ChevronsRight", "Chrome",
  "Circle", "Clipboard", "Clock11", "Cloud", "Code",
  "Codepen", "Command", "Compass", "Copy", "CornerDownLeft",
  "CreditCard", "Crop", "Crosshair", "Database", "Divide",
  "DollarSign", "DownloadCloud", "Droplet", "Edit2", "ExternalLink",
  "EyeOff", "Facebook", "FastForward", "Feather", "Figma",
  "Film", "Flag", "FolderMinus", "FolderPlus", "Framer",
  "Frown", "Gift", "GitBranch", "GitCommit", "GitMerge",
  "GitPullRequest", "Github", "Globe2", "Grid", "HardDrive",
  "Hash", "Headphones", "HeartPulse", "HelpCircle", "Hexagon",
  "Home2", "Image", "Inbox", "Instagram", "Italic", "Keypad",
  "LayersPlus", "Layout", "LifeBuoy", "Link2", "Linkedin",
  "List", "Loader", "LockClosed", "LogIn", "LogOut", "MapPin",
  "Maximize2", "MessageSquare", "MicOff", "Minimize2", "MinusCircle",
  "Monitor", "MoonStar", "MoreHorizontal", "Move", "Navigation",
  "Octagon", "Package", "Paperclip", "PauseCircle", "PenTool",
  "Percent", "PhoneCall", "PieChart2", "PlayCircle", "PlusCircle",
  "Pocket", "PowerOff", "Printer", "Radio", "Repeat1", "Rewind",
  "RotateCw", "Rss", "Save2", "Scissors", "SearchCheck",
  "SendPlane", "Server", "Settings2", "Share", "ShieldOff",
  "ShoppingBag", "Shuffle", "Sidebar", "SkipBack", "Slack",
  "Smartphone", "Speaker", "Square", "StarHalf", "StopCircle",
  "Sunrise", "Tablet", "Tag2", "Target", "TerminalSquare",
  "Thermometer", "ThumbsDown", "ToggleLeft", "Toolbox",
  "Trash", "Twitch", "Twitter", "Type", "Umbrella2", "Underline",
  "Unlock2", "UploadCloud", "UserCheck", "UserMinus", "UserPlus",
  "Users2", "VideoOff", "Voicemail", "Volume", "WatchOff",
  "WifiSignal1", "WifiSignal2", "WifiSignal3", "Wind",
  "XCircle", "Youtube", "ZapCloud", "ZoomQuestion", "ZoomReset"
];
