...
import { ArrowLeft, AlertCircle, CheckCircle2, TrendingUp, Heart, Shield, BookOpen, BarChart3, Target, Clock, Loader2, Mail } from 'lucide-react';
...
export function AnaesthesiaRiskResultsPage() {
  ...
  useEffect(() => {
    // Show email prompt after report loads successfully
    if (aiReport && !loading && !error) {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Email Prompt - Shows on page load */}
      {showEmailPrompt && (
