...
export function CardiometabolicRiskInformationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    sessionStorage.setItem('cardiometabolicRiskUserInfo', JSON.stringify(userInfo));
        ...
        <div className="mt-8">
          ...
          <div className="bg-muted/30 p-6 rounded-lg text-center">
            <p className="text-sm text-muted-foreground">
              We take your privacy seriously. All information you provide is kept strictly confidential and handled in accordance with established medical data protection standards, including the UK General Data Protection Regulation (UK GDPR), the Data Protection Act 2018, and where relevant, the NHS Data Security and Protection Toolkit. If you are based internationally, we also follow applicable frameworks such as the EU GDPR and HIPAA (Health Insurance Portability and Accountability Act). Your details will never be shared with third parties without your consent, and are stored securely to protect your confidentiality at all times.
            </p>
          </div>
        </div>
      </div>
