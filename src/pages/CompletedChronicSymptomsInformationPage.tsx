...
export function CompletedChronicSymptomsInformationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    sessionStorage.setItem('completedChronicSymptomsUserInfo', JSON.stringify(userInfo));
