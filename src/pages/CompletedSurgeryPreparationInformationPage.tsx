...
export function CompletedSurgeryPreparationInformationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    sessionStorage.setItem('completedSurgeryPreparationUserInfo', JSON.stringify(userInfo));
