...
import { ArrowLeft, AlertCircle, CheckCircle2, TrendingUp, Shield,AlertTriangle, BarChart3, Clock, Target, BookOpen, Loader2, Mail } from 'lucide-react';
  ...
  useEffect(() => {
    const loadReport = () => {
      try {
        ...
        if (storedAssessmentType !== 'Complication Risk') {
