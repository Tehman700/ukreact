  ...
  const generateReview = () => {
    const getIntroPhrase = (rating: number) => {
      const highRatingIntros = [
        ...
        "Just finished the Complication Risk Checker - what a thorough and professional assessment.",
    ...
    if (rating > 0 || selectedPositiveFeedback.length > 0 || selectedNegativeFeedback.length > 0) {
      ...
      if (rating >= 4) {
        const conclusions = [
          ...
          "I'm giving this a strong recommendation for anyone concerned about surgical risks.",
        ...
        const conclusions = [
          "It's worth trying if you're looking for surgical risk assessment tools.",
          "A decent option among the various risk assessment resources available.",
