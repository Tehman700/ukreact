...
// Complication Risk Checker Assessment definition
const complicationRiskAssessment: Assessment = {
  ...
  price: 40.00, // Fixed: was 39.99, now matches globalAssessments
  image: 'https://images.unsplash.com/photo-1682365114794-14b870355d21?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtZWRpY2FsJTIwY29tcGxpY2F0aW9uJTIwcmlzayUyMGFzc2Vzc21lbnR8ZW58MXx8fHwxNzU3MzE1NjUyfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
  icon: <AlertTriangle className="w-6 h-6" />,
  features: ['Lifestyle risk factor analysis', 'Comorbidity assessment scoring', 'Personalized prevention strategies']
};

export function ComplicationRiskUpsellPage() {
  ...
  const handleStartAssessment = () => {
    addToBasket(complicationRiskAssessment);
  };
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <p className="text-lg text-muted-foreground max-w-md">
                  Identify your hidden risk factors and get specific strategies to minimize surgical complications.
                </p>
      ...
      <section className="py-8 pt-[35px] pr-[0px] pb-[28px] pl-[0px]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-4">
            ...
            <h2 className="text-muted-foreground text-left">Your personalized Complication Risk Assessment reveals lifestyle and health factors that could impact your surgery — with specific strategies to address them beforehand.</h2>
            <p className="text-left text-muted-foreground mt-6">
              This assessment identifies factors unique to you that may increase your risk of surgical complications. Understanding these hidden risks is vital because it helps you take proactive steps, work with your healthcare team to optimize your health, and significantly improve your surgical outcomes and recovery experience.
            </p>
          </div>
        </div>
      </section>

      {/* Complication Risk Assessment Card */}
                ...
                <div className="space-y-4 flex-1 flex flex-col">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      {complicationRiskAssessment.description}
                    </p>
                  </div>
                    ...
                    <Accordion type="single" collapsible className="w-full">
                      <AccordionItem value="what-included">
                        ...
                        <AccordionContent className="text-sm text-muted-foreground space-y-3">
                          <ul className="space-y-2">
                            ...
                            <li className="flex items-center">
                              <div className="w-1 h-1 bg-muted-foreground rounded-full mr-2" />
                              Comorbidity assessment scoring
                            </li>
                            <li className="flex items-center">
                              <div className="w-1 h-1 bg-muted-foreground rounded-full mr-2" />
                      ...
                      <AccordionItem value="how-long">
                        ...
                        <AccordionContent className="text-sm text-muted-foreground">
                          The assessment takes just 5-7 minutes to complete online. Your results are usually ready the same day, and we'll send you a detailed report with personalized risk reduction strategies straight to your email.
                        </AccordionContent>
                      </AccordionItem>
                      ...
                      <AccordionItem value="who-for">
                        ...
                        <AccordionContent className="text-sm text-muted-foreground">
                          This assessment is designed for individuals preparing for surgery who want to identify and minimize potential complications. It's particularly valuable for men over 40 who may have multiple health factors that could impact surgical outcomes. By identifying hidden risks early, it supports patients who want to optimize their health and improve their surgery success rates.
                        </AccordionContent>
                      </AccordionItem>
