  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const reportResponse = await fetch("https://luther.health/api/generate-assessment-report", {
        ...
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          assessmentType: "Daily Energy", // Make sure this matches exactly
      ...
      sessionStorage.setItem("assessmentType", "Daily Energy");
      ...
      window.location.hash = "daily-energy-audit-results";
    } catch (err) {
