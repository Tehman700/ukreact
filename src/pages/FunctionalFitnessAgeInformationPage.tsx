...
export function FunctionalFitnessAgeInformationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    sessionStorage.setItem('functionalFitnessAgeUserInfo', JSON.stringify(userInfo));
