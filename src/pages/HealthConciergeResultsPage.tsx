...
import { ArrowLeft, AlertCircle, CheckCircle2, TrendingUp, Target, BookOpen, BarChart3, Clock, Loader2, Sparkles, Calendar, Users, Mail, Download } from 'lucide-react';
  ...
  try {
    ...
    fetch('https://luther.health/api/send-email-report', {
      ...
      body: JSON.stringify({
        ...
        assessmentType: 'Health Concierge',
        report: aiReport,
        reportId: Date.now(),
