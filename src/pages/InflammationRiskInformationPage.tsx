  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const reportResponse = await fetch("https://luther.health/api/generate-assessment-report", {
        ...
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          assessmentType: "Inflammation", // Make sure this matches exactly
      ...
      sessionStorage.setItem("assessmentType", "Inflammation");
      ...
      window.location.hash = "inflammation-risk-score-results";
    } catch (err) {
