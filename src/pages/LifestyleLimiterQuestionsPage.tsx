...
export function LifestyleLimiterQuestionsPage() {
  const convertAnswersToLabels = (answers: Record<string, any>) => {
    ...
    lifestyleLimiterQuiz.questions.forEach((q) => {
  ...
  const quizWithSubmit: QuizConfig = {
    ...lifestyleLimiterQuiz,
    informationPageRoute: "lifestyle-limiter-score-results",
    onComplete: async (answers) => {
      console.log("Lifestyle Limiter Score Assessment completed:", answers);
