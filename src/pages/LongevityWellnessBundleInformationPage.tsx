...
export function LongevityWellnessBundleInformationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    sessionStorage.setItem('longevityWellnessBundleUserInfo', JSON.stringify(userInfo));
