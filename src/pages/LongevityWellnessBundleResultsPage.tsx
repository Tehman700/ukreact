...
import { ArrowLeft, AlertCircle, CheckCircle2, TrendingUp, Clock, Heart, Activity, Zap, Apple,Shield,Brain, BarChart3, Target, BookOpen, Loader2,Mail } from 'lucide-react';
...
export function LongevityWellnessBundleResultsPage() {
  ...
  useEffect(() => {
    const loadReport = () => {
      try {
        ...
        if (storedAssessmentType !== 'Longevity Wellness Bundle') {
    ...
    try {
      ...
      fetch('https://luther.health/api/send-email-report', {
        ...
        body: JSON.stringify({
          ...
          assessmentType: 'Longevity Wellness Bundle',
          report: aiReport,
          reportId: Date.now(),
  ...
  const getOverallRating = (rating: string) => {
    const levelMap: Record<string, 'optimal' | 'high' | 'moderate' | 'low'> = {
      'Exceptionally Optimized': 'optimal',
      'Well Optimized': 'high',
      'Moderately Optimized': 'moderate',
      'Needs Optimization': 'low'
    };
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Analyzing your comprehensive longevity profile...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <Card className="mb-8">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Completed on {completionDate} • Complete 5-domain longevity optimization bundle
            </CardDescription>
          </CardHeader>
          <CardContent className="text-center">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground max-w-md mx-auto">
                Your comprehensive longevity assessment reveals optimization potential across all critical longevity domains.
              </p>
            </div>
          </CardContent>
        </Card>
          ...
          <div className="space-y-8">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  ...
                  <span>Your Longevity Profile vs Benchmarks</span>
                </CardTitle>
                <CardDescription>
                  How your longevity optimization compares to typical age-matched individuals and optimal targets
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            {results.map((result, index) => {
              const analysis = result.detailedAnalysis || {
                ...
                timeline: 'Discuss optimization timeline with your longevity specialist.'
              };
                  ...
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <CardDescription>
                          Longevity Score: {result.score}/{result.maxScore} • Level: {result.level}
                        </CardDescription>
                      </div>
                      <Badge variant={getScoreBadgeVariant(result.level)} className={getScoreColor(result.level)}>
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Evidence-based strategies to optimize all aspects of your longevity potential
                </CardDescription>
              </CardHeader>
              <CardContent>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Address the longevity domains where you scored lowest for maximum healthspan extension.</p>
                  </div>
                  <div>
                    <h4 className="font-medium">Coordinate with Healthcare Team</h4>
                    <p className="text-sm text-muted-foreground">Share these results with your healthcare providers for personalized longevity optimization.</p>
                  </div>
                  <div>
                    <h4 className="font-medium">Consider Advanced Testing</h4>
                    <p className="text-sm text-muted-foreground">Advanced biomarker testing can provide deeper insights into your biological age and optimization opportunities.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4 border-t border-muted">
                <p className="text-xs text-muted-foreground">
                  <strong>Disclaimer:</strong> This comprehensive longevity optimization bundle is based on validated aging and longevity research. Results are for informational purposes and should not replace professional medical evaluation.
                </p>
              </div>
                  </AccordionContent>
                </AccordionItem>
