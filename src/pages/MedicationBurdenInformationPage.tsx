  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const reportResponse = await fetch("https://luther.health/api/generate-assessment-report", {
        ...
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          assessmentType: "Medication Burden", // Make sure this matches exactly
      ...
      sessionStorage.setItem("assessmentType", "Medication Burden");
      ...
      window.location.hash = "medication-burden-calculator-results";
    } catch (err) {
