  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const reportResponse = await fetch("https://luther.health/api/generate-assessment-report", {
        ...
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          assessmentType: "Mobility", // Make sure this matches exactly
      ...
      sessionStorage.setItem("assessmentType", "Mobility");
      ...
      window.location.hash = "mobility-strength-score-results";
    } catch (err) {
