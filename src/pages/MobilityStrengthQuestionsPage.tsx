...
const mobilityStrengthQuiz: QuizConfig = {
  ...
  questions: [
    {
      id: 'walking-ability',
      question: 'How far can you walk without stopping or experiencing significant discomfort?',
      subtitle: 'Walking endurance is a key indicator of cardiovascular fitness and lower body strength',
      options: [
    ...
    {
      id: 'sit-to-stand',
      question: 'How many times can you stand up from a chair without using your arms in 30 seconds?',
    ...
    },
    {
      ...
      subtitle: 'Grip strength correlates with overall body strength and health',
      options: [
    ...
    },
    {
      ...
      subtitle: 'Functional independence indicates overall physical capacity',
      multiSelect: true,
      options: [
    ...
    },
    {
      ...
      subtitle: 'Pain and stiffness can significantly impact recovery and rehabilitation',
      options: [
    ...
    },
    {
      ...
      subtitle: 'Regular activity indicates better baseline fitness for recovery',
      options: [
  ...
  onComplete: (answers) => {
    console.log('Mobility & Strength Assessment completed with answers:', answers);
    window.location.hash = 'mobility-strength-score-information';
  },
  onBack: () => {
