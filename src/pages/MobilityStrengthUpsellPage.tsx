...
const mobilityStrengthAssessment: Assessment = {
  ...
  price: 50.00, // Fixed: was 49.99, now matches globalAssessments
  image: 'https://images.unsplash.com/photo-1740572497450-4f4f2d3be984?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2JpbGl0eSUyMHN0cmVuZ3RoJTIwYXNzZXNzbWVudCUyMHBoeXNpY2FsJTIwdGhlcmFweXxlbnwxfHx8fDE3NTczMTU2NjF8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
...
export function MobilityStrengthUpsellPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <p className="text-lg text-muted-foreground max-w-md">
                  Establish your physical baseline and optimize your recovery potential with targeted rehabilitation.
                </p>
      ...
      <section className="py-8 pt-[35px] pr-[0px] pb-[28px] pl-[0px]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-4">
            ...
            <h2 className="text-muted-foreground text-left">Your personalized Mobility & Strength Assessment creates a precise baseline to measure recovery progress and optimize rehabilitation outcomes.</h2>
      ...
      {/* Mobility & Strength Assessment Card */}
                  ...
                  <div className="flex-1">
                    <Accordion type="single" collapsible className="w-full">
                      ...
                      <AccordionItem value="who-for">
                        ...
                        <AccordionContent className="text-sm text-muted-foreground">
                          This assessment is designed for individuals preparing for surgery who want to optimize their recovery outcomes through precise baseline measurement and progress tracking. It's particularly valuable for men facing joint replacement, spinal surgery, or other procedures affecting mobility. By establishing your baseline, it supports both patients and physiotherapists in creating effective rehabilitation plans.
                        </AccordionContent>
                      </AccordionItem>
