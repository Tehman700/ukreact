...
import { ArrowLeft, AlertCircle, CheckCircle2, TrendingUp,Shield, Clock, BarChart3, Target, BookOpen, Apple, Loader2, Mail } from 'lucide-react';
...
export function NutritionBodyCompositionResultsPage() {
  ...
  useEffect(() => {
    const loadReport = () => {
      try {
        ...
        if (storedAssessmentType !== 'Nutrition Composition') {
  ...
  const getNutritionLevel = (rating: string) => {
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Analyzing your nutrition profile...</p>
        </div>
      </div>
    );
  }
  ...
  const nutritionLevel = getNutritionLevel(overallRating);
              ...
              <div>
                ...
                <div className="flex items-center justify-center gap-4 text-sm">
                  ...
                  <span className="text-muted-foreground">
                    {overallScore >= 85 ? 'Excellent foundation' : overallScore >= 70 ? 'Strong foundation for optimization' : 'Clear opportunities for improvement'}
                  </span>
                </div>
              </div>
              <Progress value={overallScore} className="w-full max-w-md mx-auto" />
              <p className="text-muted-foreground max-w-md mx-auto">
                Your nutrition and body composition assessment reveals {overallScore >= 85 ? 'excellent' : overallScore >= 70 ? 'good' : 'moderate'} foundational health with {overallScore >= 85 ? 'minor' : 'clear'} opportunities for optimization.
              </p>
            </div>
          </CardContent>
        </Card>
          ...
          <div className="space-y-8">
            ...
            {results.map((result, index) => {
              const analysis = result.detailedAnalysis || {
                ...
                riskFactors: ['Consult with nutrition professional'],
                timeline: 'Improvements typically measurable within 4-8 weeks.'
              };
        ...
        {activeTab === 'recommendations' && (
          <div className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  ...
                  <span>Personalized Nutrition Optimization Plan</span>
                </CardTitle>
                <CardDescription>
            ...
            {aiReport.summary && (
              <Card>
                <CardHeader>
                  <CardTitle>Comprehensive Nutrition Analysis</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-medium">Consider Professional Support</h4>
                      <p className="text-sm text-muted-foreground">Work with a registered dietitian for personalized nutrition optimization and body composition goals.</p>
                    </div>
                  </div>
                </div>
              </CardContent>
