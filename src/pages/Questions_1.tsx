...
export function Questions_1() {
  ...
  const surgeryReadinessQuizWithAnalytics: QuizConfig = {
    ...
    informationPageRoute: 'surgery-readiness-information-one',
    onComplete: async (answers) => {
      ...
      window.location.hash = "surgery-readiness-information-one";
    },
  ...
  React.useEffect(() => {
    // ✅ STEP 1: Track that user is in Variant A
