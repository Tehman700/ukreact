...
export function Questions_2() {
  ...
  const surgeryReadinessQuizWithAnalytics: QuizConfig = {
    ...
    informationPageRoute: 'surgery-readiness-information-two',
    onComplete: async (answers) => {
      ...
      window.location.hash = "surgery-readiness-information-two";
    },
  ...
  React.useEffect(() => {
    // ✅ STEP 1: Track that user is in Variant B
