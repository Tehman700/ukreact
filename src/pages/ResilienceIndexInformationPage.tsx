...
export function ResilienceIndexInformationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    sessionStorage.setItem('resilienceIndexUserInfo', JSON.stringify(userInfo));
