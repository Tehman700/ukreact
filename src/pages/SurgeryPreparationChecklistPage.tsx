  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center py-8 px-4">
      <div className="w-full max-w-md">
          ...
          <div className="p-8">
            ...
            <div className="flex relative flex-col items-center mb-8">
              ...
              <div className="text-center absolute mt-2 bottom-0">
                ...
                <p className="text-sm text-gray-500 mt-1">Surgery readiness</p>
              </div>
            </div>
            ...
            <div className="mt-2">
              ...
              <div className="space-y-3">
                {[1, 2, 3].map((id) => (
                  <div
                    key={id}
                    className="risk-driver-item flex items-center justify-between p-3 bg-gray-50 rounded-xl"
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div
                        className=" text-gray-600 text-base font-bold select-none"
                        style={{
                          filter: "blur(4px)",
                      ...
                      >
                        Top 3 Risk Drivaa bgfvhbf sxdgfvdg  
                      </div>
                    </div>
        ...
        <div className="bg-white rounded-2xl unlock-plan-section p-6">
          ...
          <div className="space-y-3 mb-6">
            ...
            <path fill-rule="evenodd" clip-rule="evenodd" d="M0 5.5C0 4.04131 0.579463 2.64236 1.61091 1.61091C2.64236 0.579463 4.04131 0 5.5 0C6.95869 0 8.35764 0.579463 9.38909 1.61091C10.4205 2.64236 11 4.04131 11 5.5C11 6.95869 10.4205 8.35764 9.38909 9.38909C8.35764 10.4205 6.95869 11 5.5 11C4.04131 11 2.64236 10.4205 1.61091 9.38909C0.579463 8.35764 0 6.95869 0 5.5ZM5.18613 7.854L8.35267 3.89547L7.78067 3.43787L5.08053 6.81193L3.168 5.2184L2.69867 5.7816L5.18613 7.854Z" fill="#89BF57"/>
            </svg>
            ...
            <path fill-rule="evenodd" clip-rule="evenodd" d="M0 5.5C0 4.04131 0.579463 2.64236 1.61091 1.61091C2.64236 0.579463 4.04131 0 5.5 0C6.95869 0 8.35764 0.579463 9.38909 1.61091C10.4205 2.64236 11 4.04131 11 5.5C11 6.95869 10.4205 8.35764 9.38909 9.38909C8.35764 10.4205 6.95869 11 5.5 11C4.04131 11 2.64236 10.4205 1.61091 9.38909C0.579463 8.35764 0 6.95869 0 5.5ZM5.18613 7.854L8.35267 3.89547L7.78067 3.43787L5.08053 6.81193L3.168 5.2184L2.69867 5.7816L5.18613 7.854Z" fill="#89BF57"/>
              ...
              <span className="text-sm font-semibold text-gray-600">
                Get the exact steps your need to reverse risks
              </span>
            </div>
            <div className="flex items-center gap-3">
              <svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div className="payment-badge">
                <img
                  src="/assests/appleicon.svg"
                  alt="Apple Pay"
                  className="payment-badge-icon"
                />
              </div>
              {/* Stripe */}
              <div className="payment-badge">
                <img
                  src="/assests/stripeicon.svg"
                  alt="Stripe"
                  className="payment-badge-icon"
                />
              </div>
