...
import { PaymentGate } from "../components/PaymentGate"; // <-- payment gate

// Symptom Severity Quiz Config
...
export function SymptomSeverityQuestionsPage() {
  const quizWithSubmit: QuizConfig = {
    ...symptomSeverityQuiz,
    informationPageRoute: "symptom-severity-index-results",
    onComplete: async (answers) => {
      console.log("Symptom Severity Assessment completed:", answers);
      sessionStorage.setItem(
        "pendingAnswers",
        JSON.stringify(convertAnswersToLabels(answers))
      );
      window.location.hash = "symptom-severity-index-information"; // go to info page
    },
    onBack: () => {
