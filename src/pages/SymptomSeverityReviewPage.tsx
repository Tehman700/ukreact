...
export function SymptomSeverityReviewPage() {
  ...
  const generateReview = () => {
    ...
    const getIntroPhrase = (rating: number) => {
      const highRatingIntros = [
        "I recently completed the Symptom Severity Index and was impressed with the comprehensive analysis.",
        "Just finished the Symptom Severity Index - what a thorough and professional assessment.",
        "The Symptom Severity Index exceeded my expectations in identifying symptom patterns.",
        "As someone dealing with chronic symptoms, I found the Symptom Severity Index incredibly valuable."
      ];
      const midRatingIntros = [
        "I completed the Symptom Severity Index and found it to be a solid resource overall.",
        "The Symptom Severity Index provided useful insights, though there's room for improvement.",
        "I went through the Symptom Severity Index and had a generally positive experience.",
        "The Symptom Severity Index was helpful in certain areas, with mixed results in others."
      ];
      const lowRatingIntros = [
        "I tried the Symptom Severity Index but unfortunately didn't find it as helpful as I'd hoped.",
        "While I appreciate the concept behind the Symptom Severity Index, the execution fell short for me.",
        "I completed the Symptom Severity Index but came away with mixed feelings about the experience.",
        "The Symptom Severity Index has potential, but there are several areas that need improvement."
      ];
    ...
    const createFeedbackSentence = (positive: string[]) => {
      ...
      if (positive.length > 0) {
        const positiveConnectors = [
          ...
          "I found the symptom analysis especially",
    ...
    if (rating >= 4) {
      const conclusions = [
        "Overall, I'd definitely recommend this to anyone dealing with chronic symptoms.",
        "I'm giving this a strong recommendation for anyone seeking symptom clarity.",
        "Would absolutely use this again and recommend it to others.",
        "This has genuinely helped me understand my symptom patterns better."
      ];
      review += conclusions[Math.floor(Math.random() * conclusions.length)];
    } else if (rating === 3) {
      const conclusions = [
        "It's worth trying if you're looking for symptom assessment tools.",
        "A decent option among the various symptom tracking resources available.",
    ...
    setGeneratedReview(review.replace(/\s+/g, ' ').trim());
      ...
      <div className="min-h-screen bg-background py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-8">
            <h1 className="mb-4">Did you find the Symptom Severity Index helpful?</h1>
